mapboxgl.accessToken =
        ...
        const map = new mapboxgl.Map({
            ...
            style: 'mapbox://styles/mapbox/Moonlight',
...
let response = await fetch('geog458-covidmap/assets/covidcount.geojson');
let covidcount = await response.json();
    ...
    var labels = ['<strong>COVID-19 Case Number </strong>'], vbreak;
